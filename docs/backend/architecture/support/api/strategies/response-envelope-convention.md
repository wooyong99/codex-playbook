...
이 문서는 `support/api`의 공통 응답 DTO와 pagination envelope 전략을 정리한다.
...
도메인별 Response DTO field는 [app/api dto convention](../../../app/api/strategies/dto-convention.md)이 소유한다.
