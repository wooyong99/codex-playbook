...
이 문서는 `implement-frontend` 스킬의 frontend Markdown input artifact, output artifact, 체크포인트 파일, 결과 신호, 검증 절차를 소유한다. 세부 Case와 역할별 Markdown 섹션은 frontend 계약 문서가 단일 출처다.
