...
`write-frontend-tech-design-doc` 스킬의 상세 절차와 문서 템플릿을 분리해 `SKILL.md`를 고수준 운영 문서로 유지한다.

## 적용 범위

이 디렉토리는 프론트엔드 기술설계문서 작성에 필요한 세부 흐름과 산출물 구조를 소유한다. 스킬 호출 조건과 최상위 책임은 [../SKILL.md](../SKILL.md)가 소유한다.
