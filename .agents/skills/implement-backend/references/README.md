...
| L1 | [orchestration-boundaries.md](orchestration-boundaries.md) | 메인 에이전트와 backend 역할 서브에이전트의 책임 경계 |
...
| L3 | [backend-technical-design-writer-contract.md](backend-technical-design-writer-contract.md) | Backend Design Writer 호출 계약 |
| L3 | [backend-implementation-engineer-contract.md](backend-implementation-engineer-contract.md) | Backend Implementation Engineer 호출 계약 |
| L3 | [backend-architecture-reviewer-contract.md](backend-architecture-reviewer-contract.md) | Backend Architecture Reviewer 호출 계약 |
