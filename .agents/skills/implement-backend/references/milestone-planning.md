...
실행 중 design/implementation/review 호출 순서는 [milestone-execution-workflow.md](milestone-execution-workflow.md)가 소유하고, 파일 저장 규칙은 [run-artifact-protocol.md](run-artifact-protocol.md)가 소유한다.
